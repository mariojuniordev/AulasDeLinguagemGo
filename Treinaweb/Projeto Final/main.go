...
// GerenciadorContatos : componente reponsável por gerenciar contatos
type GerenciadorContatos struct{}

func (gerenciador *GerenciadorContatos) carregarContatos() ([]Contato, error) {
	contatos := make([]Contato, 0) //Syntax do Slice
	//.isNotExist - método do objeto os que verifica se
	//um arquivo ou variável existe
